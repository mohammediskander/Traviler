//
//  FavourtiesCollectionController.swift
//  Traviler
//
...
enum FavourtiesCellIdentifier: String {
    case `default`
}
...
extension FavourtiesCollectionController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        (BusinessDataStore.shared?.dumpData["favourits"] ?? []).count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.business = (BusinessDataStore.shared?.dumpData["favourits"] ?? [])![indexPath.row]
        
        return cell
    }
}

extension FavourtiesCollectionController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        
        let business = (BusinessDataStore.shared?.dumpData["favourits"] ?? [])[indexPath.row]
